    ...
    return (
        <Link
            ...
            className={`flex w-full items-start border-l-4 py-2 pe-4 ps-3 ${active
                ? 'border-indigo-400 dark:border-indigo-500 bg-indigo-50 dark:bg-indigo-950/50 text-indigo-700 dark:text-indigo-200 focus:border-indigo-700 dark:focus:border-indigo-400 focus:bg-indigo-100 dark:focus:bg-indigo-900/50 focus:text-indigo-800 dark:focus:text-indigo-100'
